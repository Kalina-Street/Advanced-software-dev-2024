/*Admin Profle Page*/
/*Displays Admin's profile details, uses Sprofile.js as reference - Kamil*/
...
//Create function to display admin profile
export default function Aprofile() {
  const navi = useNavigate();
  let user = 0;
  let mapp = null;
  //fetches navigational map and admin details
  useEffect(() => {
  ...
  return (
    ...
    // display is block to make it the first page to appear and viually see
